        ...
        <v-card-text>
          ...
          >
            ...
            <v-text-field 
              ...
              required
              :rules="[() => currentIngredient.length <= 50 || 'Ingredient must be less than 50 characters']"
  ...
  methods: {
    ...
    async getSingleRecipe() {
      try {
        ...
        this.cookTime = this.recipeData.cook_time
        this.prepTime = this.recipeData.prep_time
        this.servings = this.recipeData.servings
        this.content = this.recipeData.description
        this.type = this.recipeData.type
        this.ingredients = this.recipeData.ingredients
        this.steps = this.recipeData.steps
        this.image = this.recipeData.photo
      } catch (err) {
        console.log(err)
      }
    },
